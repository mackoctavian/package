            ...
            <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
                <div className="text-center">
                    ...
                    <div className="flex justify-center ">
                        <Link href="/donation" className="text-white bg-linear-to-r from-error to-warning px-7 py-5 hover:from-transparent hover:to-transparent border border-transparent hover:border-error hover:text-error rounded-sm">
                            Donate now
                        </Link>
                    </div>
                </div>
